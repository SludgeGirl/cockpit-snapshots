...
A [Cockpit](https://cockpit-project.org/) module for managing Snapper snapshots, built with [Cockpit Starter Kit](https://github.com/cockpit-project/starter-kit).
...
```
git clone https://github.com/openSUSE/cockpit-snapshots.git
cd cockpit-snapshots
make
```
...
ln -s `pwd`/dist ~/.local/share/cockpit/cockpit-snapshots
```
...
remove manually the symlink:
    ...
    rm ~/.local/share/cockpit/cockpit-snapshots
